!(function(Q, T, s) {
  ...
  function r(b, a, c) {
    ...
    if (b)
      ...
      else if ($a(b)) for (d = 0; d < b.length; d++) a.call(c, b[d], d);
  ...
  function $(b, a) {
    ...
    if (a) {
      if (b === a) throw Oa('cpi');
      if (M(b)) for (var c = (a.length = 0); c < b.length; c++) a.push($(b[c]));
      else {
        (c = a.$$hashKey),
          r(a, function(b, c) {
            delete a[c];
  ...
  function ua(b, a) {
    ...
    if (c == typeof a && 'object' == c) {
      ...
      if ((c = b.length) == a.length) {
        for (d = 0; c > d; d++) if (!ua(b[d], a[d])) return !1;
        return !0;
      }
    }
    return !1;
  ...
  function Yb(b, a) {
    ...
    return Q && !d.test(Q.name)
      ? c()
      : ((Q.name = Q.name.replace(d, '')),
        void (Ca.resumeBootstrap = function(b) {
          r(b, function(b) {
            a.push(b);
          }),
            c();
  ...
  function ib(b, a, c) {
    for (
      b = w(b), 9 == b[0].nodeType && (b = b.find('html')), a = M(a) ? a : [a];
      b.length;
    ...
    return (
      'function' == typeof b
        ? (a = b.$inject) ||
          ((a = []),
          b.length &&
            ((c = b.toString().replace(je, '')),
            (c = c.match(ke)),
            r(c[1].split(le), function(b) {
  ...
  function Zb(b) {
    ...
    function c(a, b) {
      if ((xa(a, 'service'), (D(b) || M(b)) && (b = n.instantiate(b)), !b.$get))
        throw Va('pget', a);
      return (l[a + h] = b);
    }
    function d(a, b) {
  ...
  function ne(b, a, c, d) {
            ...
            ? ((J = a),
              d.history
                ? c
                  ...
                  : (l.pushState(null, '', a), F.attr('href', F.attr('href')))
                : ((y = a), c ? k.replace(a) : (k.href = a)),
              h)
            : void 0
          : y || k.href.replace(/%27/g, "'")
      );
    };
    var ba = [],
      S = !1;
    (h.onUrlChange = function(a) {
      return (
        S ||
          (d.history && w(b).on('popstate', g),
          d.hashchange ? w(b).on('hashchange', g) : h.addPollFn(g),
          (S = !0)),
        ba.push(a),
        a
      );
          ...
          for (
            ...
            (e = d[f]),
              ...
              h > 0 &&
                ...
                N[a] === s && (N[a] = unescape(e.substring(h + 1))));
        return N;
      }
      b === s
        ? (m.cookie =
        ...
        : x(b) &&
          ((d =
            (m.cookie = escape(a) + '=' + escape(b) + ';path=' + U).length + 1),
          d > 4096 &&
            c.warn(
              "Cookie '" +
                a +
      ...
      function b(b, d) {
        ...
        return (a[b] = {
          put: function(a, b) {
            ...
            return E(b)
              ? void 0
              : (a in m || g++, (m[a] = b), g > k && this.remove(q.key), b);
          },
          get: function(a) {
            if (k < Number.MAX_VALUE) {
              var b = l[a];
  ...
  function ac(b, a) {
    ...
    (this.directive = function k(a, e) {
      ...
      (this.$get = [
        ...
        '$animate',
        '$$sanitizeUri',
        function(a, b, n, q, p, t, H, C, A, J, F, y) {
          ...
          function N(a, b, c, d, e, f) {
            ...
            for (var k, l, n, p, g = [], t = 0; t < a.length; t++)
              (k = new Fb()),
                (l = U(a[t], [], k, 0 === t ? d : s, e)),
                (f = l.length ? Wa(l, a[t], k, b, c, null, [], [], f) : null) &&
                  f.scope &&
                  S(w(a[t]), 'ng-scope'),
                (k =
                  (f && f.terminal) || !(n = a[t].childNodes) || !n.length
                    ? null
                    : N(n, f ? f.transclude : b)),
                g.push(f, k),
                (p = p || f || k),
                (f = null);
            return p ? h : null;
          ...
          function U(a, b, c, d, h) {
            ...
            switch (a.nodeType) {
              case 1:
                ...
                var l, n, p;
                k = a.attributes;
                for (var t = 0, q = k && k.length; q > t; t++) {
                  var H = !1,
                    C = !1;
                  if (((l = k[t]), !P || P >= 8 || l.specified)) {
                    (n = l.name),
                      (p = ka(n)),
                ...
                if (((a = a.className), x(a) && '' !== a))
                  for (; (k = f.exec(a)); )
                    (p = ka(k[2])),
                      u(b, p, 'C', d, h) && (c[p] = aa(k[3])),
            ...
            for (
              ...
              if (
                ((v = G.scope) &&
                  ((A = A || G),
                  G.templateUrl ||
                    (Q('new/isolated scope', N, G, K), W(v) && (N = G))),
                (ga = G.name),
                !G.templateUrl &&
                  G.controller &&
                  ((v = G.controller),
                  (F = F || {}),
                  Q("'" + ga + "' controller", F[ga], G, K),
                  (F[ga] = G)),
                (v = G.transclude) &&
                  ((Wa = !0),
                  G.$$tlb || (Q('transclusion', u, G, K), (u = G)),
                  'element' == v
                    ? ((Ja = !0),
                      (y = G.priority),
                      (v = I(c, R, V)),
                      (K = d.$$element = w(
                        T.createComment(' ' + ga + ': ' + d[ga] + ' ')
                      )),
                      (c = K[0]),
                      lb(f, w(va.call(v, 0)), c),
                      (z = ba(v, e, y, h && h.name, {
                ...
                if (
                  (Q('template', Z, G, K),
                  (Z = G),
                  (v = D(G.template) ? G.template(K, d) : G.template),
                  (v = oc(v)),
                  G.replace)
                ) {
                  if (
              ...
              if (G.templateUrl)
                Q('template', Z, G, K),
                  (Z = G),
                  G.replace && (h = G),
                  (J = O(a.splice(la, a.length - la), K, d, f, z, g, k, {
                ...
                try {
                  (L = G.compile(K, d, z)),
                    D(L) ? q(null, L, R, V) : L && q(L.pre, L.post, R, V);
                } catch (Y) {
                  n(Y, fa(K));
                }
          ...
          function u(b, e, f, h, g, l, p) {
            ...
            if (((g = null), c.hasOwnProperty(e))) {
              var t;
              e = a.get(e + d);
              for (var q = 0, H = e.length; H > q; q++)
                try {
                  (t = e[q]),
                    (h === s || h > t.priority) &&
                      -1 != t.restrict.indexOf(f) &&
                      (l && (t = Rb(t, { $$start: l, $$end: p })),
                      b.push(t),
                      (g = t));
                } catch (y) {
                  n(y);
          ...
          function E(a) {
            ...
            return (
              ...
              (b = g.exec(a))
                ? ((b = b[1].toLowerCase()),
                  (a = w('<table>' + a + '</table>')),
                  /(thead|tbody|tfoot)/.test(b)
                    ? a.children(b)
                    : ((a = a.children('tbody')),
                      'tr' === b
                        ? a.children('tr')
                        : a.children('tr').contents()))
                : w('<div>' + a + '</div>').contents()
            );
          }
          function O(a, b, c, d, e, f, h, g) {
            ...
            return (
              b.empty(),
              q
                .get(J.getTrustedResourceUrl(C), { cache: p })
                .success(function(p) {
                  var q, J;
                  if (((p = oc(p)), H.replace)) {
                    if (
                  ...
                  for (
                    ...
                    if (J !== t) {
                      var ba = J.className;
                      (g.hasElementTranscludeDirective && H.replace) ||
                        (A = Cb(q)),
                        lb(I, w(J), A),
                        S(w(A), ba);
                    }
              ...
              function(a, b, c, d, e) {
                k
                  ? (k.push(b), k.push(c), k.push(d), k.push(e))
                  : l(n, b, c, d, e);
              }
            );
          }
              ...
              c.push({
                ...
                compile: function() {
                  return {
                    pre: function(c, d, g) {
                      if (
                        ((d = g.$$observers || (g.$$observers = {})), h.test(e))
                      )
          ...
          function lb(a, b, c) {
            var h,
              ...
              f = d.parentNode;
            if (a)
              for (h = 0, g = a.length; g > h; h++)
                if (a[h] == d) {
                  (a[h++] = c), (g = h + e - 1);
                  for (var k = a.length; k > h; h++, g++)
                    k > g ? (a[h] = a[g]) : delete a[h];
                  a.length -= e - 1;
                  break;
                }
            for (
          ...
          Fb.prototype = {
            ...
            $updateClass: function(a, b) {
              var c = pc(a, b),
                d = pc(b, a);
              0 === c.length
                ? F.removeClass(this.$$element, d)
                : 0 === d.length
                  ? F.addClass(this.$$element, c)
                  : F.setClass(this.$$element, c, d);
            },
            $set: function(a, b, c, d) {
              ...
              e && (this.$$element.prop(a, b), (d = e)),
                ...
                d
                  ? (this.$attr[a] = d)
                  : (d = this.$attr[a]) || (this.$attr[a] = d = eb(a, '-')),
                (e = Ia(this.$$element)),
                (('A' === e && 'href' === a) || ('IMG' === e && 'src' === a)) &&
                  (this[a] = b = y(b, 'src' === a)),
                !1 !== c &&
                  (null === b || b === s
  ...
  function Rd() {
      ...
      e = (this.defaults = {
        transformResponse: [
          function(d) {
            return (
              x(d) &&
                ((d = d.replace(c, '')), b.test(d) && a.test(d) && (d = Ub(d))),
              d
            );
          },
        ],
    ...
    this.$get = [
      ...
      function(a, b, c, d, n, q) {
        ...
        function t(b, c, f) {
          function g(a, b, c) {
            A && (a >= 200 && 300 > a ? A.put(s, [a, b, qc(c)]) : A.remove(s)),
              k(b, a, c),
              d.$$phase || d.$apply();
          }
          function k(a, c, d) {
            (c = Math.max(c, 0)),
              (c >= 200 && 300 > c ? t.resolve : t.reject)({
                data: a,
                status: c,
                headers: rc(d),
                config: b,
          ...
          if (
            ...
            (b.cache || e.cache) &&
              !1 !== b.cache &&
              'GET' == b.method &&
              (A = W(b.cache) ? b.cache : W(e.cache) ? e.cache : C),
            A)
          )
            if (((r = A.get(s)), u(r))) {
  ...
  function qe(b) {
    if (
      8 >= P &&
      (!b.match(/^(get|post|head|put|delete|options)$/i) || !Q.XMLHttpRequest)
    )
  ...
  function re(b, a, c, d, e) {
    ...
    return function(e, m, k, l, n, q, p, t) {
      ...
      var A;
      if (
        (b.$$incOutstandingRequestCount(), (m = m || b.url()), 'jsonp' == O(e))
      ) {
        ...
        var F = f(
          m.replace('JSON_CALLBACK', 'angular.callbacks.' + J),
          function() {
  ...
  function Pd() {
    ...
    (this.startSymbol = function(a) {
      ...
      (this.$get = [
        ...
        function(c, d, e) {
          function f(f, k, l) {
            for (var n, q, p = 0, t = [], H = f.length, C = !1, A = []; H > p; )
              -1 != (n = f.indexOf(b, p)) && -1 != (q = f.indexOf(a, n + g))
                ? (p != n && t.push(f.substring(p, n)),
                  t.push((p = c((C = f.substring(n + g, q))))),
                  (p.exp = C),
                  (p = q + h),
                  (C = !0))
                : (p != H && t.push(f.substring(p)), (p = H));
            if (((H = t.length) || (t.push(''), (H = 1)), l && 1 < t.length))
              throw tc('noconcat', f);
            return !k || C
              ? ((A.length = H),
                (p = function(a) {
                  try {
                    for (var h, b = 0, c = H; c > b; b++)
                      'function' == typeof (h = t[b]) &&
                        ((h = h(a)),
                        (h = l ? e.getTrusted(l, h) : e.valueOf(h)),
                        null === h || E(h)
                          ? (h = '')
                          : 'string' != typeof h && (h = oa(h))),
                        (A[b] = h);
                    return A.join('');
                  } catch (g) {
    ...
    (this.hashPrefix = function(a) {
      ...
      (this.$get = [
        ...
        function(c, d, e, f) {
          ...
          a
            ? ((m =
                k.substring(0, k.indexOf('/', k.indexOf('//') + 2)) +
                (m || '/')),
              (e = e.history ? xc : yc))
            : ((m = Xa(k)), (e = Jb)),
            (h = new e(m, '#' + b)),
  ...
  function ue(b, a, c) {
    return (
      ...
      function(c, e) {
        return null == c
          ? s
          : ((c = (e && e.hasOwnProperty(b) ? e : c)[b]), null == c ? s : c[a]);
      }
    );
  }
  function Bc(b, a, c) {
    ...
    if (a.unwrapPromises || 1 !== e)
      if (a.unwrapPromises || 2 !== e)
        if (a.csp)
          f =
            6 > e
              ? Ac(d[0], d[1], d[2], d[3], d[4], c, a)
              : function(b, f) {
                  var g,
                    h = 0;
                  do
                    (g = Ac(d[h++], d[h++], d[h++], d[h++], d[h++], c, a)(
                      b,
                      f
                    )),
                      (f = s),
            ...
            $destroy: function() {
              if (!this.$$destroyed) {
                ...
                this.$broadcast('$destroy'),
                  (this.$$destroyed = !0),
                  this !== q &&
                    (r(this.$$listenerCount, db(null, l, this)),
                    a.$$childHead == this &&
    ...
    (this.aHrefSanitizationWhitelist = function(a) {
      ...
      (this.$get = function() {
        return function(c, d) {
          var f,
            e = d ? a : b;
          return (P && !(P >= 8)) || ((f = pa(c).href), '' === f || f.match(e))
            ? c
            : 'unsafe:' + f;
        };
      });
  ...
  function Gb(b) {
    return (
      (b = x(b) ? pa(b) : b), b.protocol === Fc.protocol && b.host === Fc.host
    );
  }
  function ce() {
    this.$get = Y(Q);
  ...
  function Gc(b) {
    ...
    return function(b, d) {
      return (
        ...
        Kc(b, a.PATTERNS[1], a.GROUP_SEP, a.DECIMAL_SEP, 2).replace(
          /\u00A4/g,
          d
        )
      );
  ...
  function Kc(b, a, c, d, e) {
    ...
    if (k) e > 0 && b > -1 && 1 > b && (h = b.toFixed(e));
    else {
  ...
  function Hc(b) {
    ...
    return function(c, e) {
      ...
      for (; e; )
        (m = De.exec(e))
          ? ((g = g.concat(va.call(m, 1))), (e = g.pop()))
          : (g.push(e), (e = null));
      return (
        r(g, function(a) {
          (h = Ee[a]),
  ...
  function sa(b) {
    return D(b) && (b = { link: b }), (b.restrict = b.restrict || 'AC'), Y(b);
  }
  function Mc(b, a, c, d) {
    function e(a, c) {
      (c = c ? '-' + eb(c, '-') : ''),
    ...
    var m = function() {
      if (!h) {
        ...
        Pa(c.ngTrim || 'T') && (e = aa(e)),
          (d.$viewValue !== e || (g && '' === e && !g.valueMissing)) &&
            (b.$$phase
              ? d.$setViewValue(e)
              : b.$apply(function() {
                  d.$setViewValue(e);
  ...
  (P = R((/msie (\d+)/.exec(O(navigator.userAgent)) || [])[1])),
    isNaN(P) &&
      (P = R((/trident\/.*; rv:(\d+)/.exec(O(navigator.userAgent)) || [])[1])),
    (B.$inject = []),
    (Ba.$inject = []);
  var aa = (function() {
  ...
  var Vc = /[A-Z]/g,
    ...
    he = 1,
    Nc = Q.document.addEventListener
      ? function(b, a, c) {
    ...
    Db = Q.document.removeEventListener
      ? function(b, a, c) {
    ...
    Ha = (L.prototype = {
      ready: function(b) {
        ...
        'complete' === T.readyState
          ? setTimeout(a)
          : (this.on('DOMContentLoaded', a), L(Q).on('load', a));
      },
      toString: function() {
        var b = [];
        return (
    ...
    r(
      {
        ...
        scope: function(b) {
          return (
            w(b).data('$scope') ||
            ib(b.parentNode || b, ['$isolateScope', '$scope'])
          );
        },
        isolateScope: function(b) {
          return (
            w(b).data('$isolateScope') || w(b).data('$isolateScopeNoTemplate')
          );
        },
        controller: ic,
        injector: function(b) {
  ...
  var qa,
    ...
    La = {
      ...
      '+': function(a, c, d, e) {
        return (
          (d = d(a, c)), (e = e(a, c)), u(d) ? (u(e) ? d + e : d) : u(e) ? e : s
        );
      },
      '-': function(a, c, d, e) {
  ...
  Lb.prototype = {
    ...
    readIdent: function() {
      ...
      if (((d = { index: d, text: c }), La.hasOwnProperty(c)))
    ...
    (Za.prototype = {
      ...
      ternary: function() {
        ...
        return this.expect('?')
          ? ((c = this.ternary()),
            (d = this.expect(':'))
              ? this.ternaryFn(a, c, this.ternary())
            ...
            r(g, function(a, c) {
              ...
              e.$watch(
                function() {
                  ...
                  return isNaN(c)
                    ? ''
                    : (c in l || (c = a.pluralCat(c - k)), n[c](e, f, !0));
                },
                function(a) {
                  f.text(a);
                }
        ...
        return {
          ...
          link: function(e, f, g, h, m) {
            ...
            e.$watchCollection(h, function(a) {
              ...
              for (A = E.length, h = z.length = E.length, g = 0; h > g; g++)
                if (
                  ((x = a === E ? g : E[g]),
                  (B = a[x]),
                  (B = n(x, B, g)),
          ...
          link: function(e, g, h, m) {
              ...
              function h() {
                ...
                for (D = 0; (I = E.length), I > D; D++) {
                  ...
                  (C[m] = z[k]),
                    ...
                    p
                      ? (d = u(s.remove(w ? w(e, C) : r(e, C))))
                      : (w
                          ? ((d = {}), (d[m] = t), (d = w(e, d) === w(e, C)))
                          : (d = t === r(e, C)),
                        (s = s || d)),
                    (F = l(e, C)),
                    (F = u(F) ? F : ''),
                ...
                for (
                  ...
                  for (
                    ...
                    (s = k[D]),
                      (d = z[D + 1])
                        ? ((F = d.element),
                          d.label !== s.label && F.text((d.label = s.label)),
                          d.id !== s.id && F.val((d.id = s.id)),
                          d.selected !== s.selected &&
                            F.prop('selected', (d.selected = s.selected)))
                        : ('' === s.id && v
                            ? (L = v)
                            : (L = A.clone())
                                .val(s.id)
                          ...
                          F ? F.after(L) : t.element.append(L),
                          (F = L));
                ...
                f.on('change', function() {
                  e.$apply(function() {
                    var a,
                      ...
                      d = {};
                    if (p) {
                      for (k = [], q = 0, v = x.length; v > q; q++)
                        for (a = x[q], l = 1, t = a.length; t > l; l++)
                          if ((h = a[l].element)[0].selected) {
                            if (((h = h.val()), n && (d[n] = h), w))
                              for (
                                u = 0;
            ...
            if (m[1]) {
              ...
              var x,
                ...
                z = A.clone();
              h = 0;
              for (var y = g.children(), D = y.length; D > h; h++)
                if ('' === y[h].value) {
                  x = v = y.eq(h);
                  break;
                }
