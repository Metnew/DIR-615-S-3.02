      ...
      function(m, p) {
        ...
        return function(h, n, l) {
          function k(d) {
            ...
            return (
              (d = (d.x - b.x) * a), v && q > s && d > 0 && d > e && g > s / d
            );
          }
          var b,
            v,
              ...
              if (e && q) {
                ...
                (m += Math.abs(n.x - g.x)),
                  ...
                  (10 > m && 10 > p) ||
                    (p > m
                      ? ((e = !1), c.cancel && c.cancel(a))
                      : (a.preventDefault(), c.move && c.move(n, a)));
              }
            }),
        ...
        function p(a) {
          if (!(Date.now() - n > g)) {
            ...
            (1 > c && 1 > b) ||
              (k && k[0] === c && k[1] === b) ||
              (k && (k = null),
              'label' === a.target.tagName.toLowerCase() && (k = [c, b]),
              m(l, c, b) ||
                (a.stopPropagation(),
                a.preventDefault(),
          ...
          b.on('touchstart', function(a) {
            ...
            b.on('touchend', function(a) {
              ...
              k &&
                ...
                12 > s &&
                (l ||
                  (c[0].addEventListener('click', p, !0),
                  c[0].addEventListener('touchstart', q, !0),
                  (l = [])),
                (n = Date.now()),
                m(l, f, h),
                t && t.blur(),
                (w.isDefined(e.disabled) && !1 !== e.disabled) ||
                  b.triggerHandler('click', [a])),
                d();
            }),
