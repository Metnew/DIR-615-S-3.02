      ...
      (this.prefix = 'ls'),
        ...
        (this.$get = [
          ...
          function(a, b, j, k, l) {
            ...
            var t = function(a) {
              ...
              w = (function() {
                try {
                  ...
                  return (
                    c && ((n = b[s]), n.setItem(d, ''), n.removeItem(d)), c
                  );
                } catch (e) {
                  return (
                    o.defaultToCookie && (s = 'cookie'),
                    a.$broadcast(
              ...
              x = function(b, c) {
                if (
                  ((c = d(c) ? null : i(c)),
                  (!w && o.defaultToCookie) || 'cookie' === o.storageType)
                )
                  return (
                    w ||
                      a.$broadcast(
              ...
              y = function(b) {
                if ((!w && o.defaultToCookie) || 'cookie' === o.storageType)
                  return (
                    w ||
                      a.$broadcast(
                        'LocalStorageModule.notification.warning',
                    ...
                    try {
                      n.removeItem(t(c)),
                        r.removeItem &&
                          a.$broadcast(
                            'LocalStorageModule.notification.removeitem',
                            { key: c, storageType: o.storageType }
                          );
                    } catch (d) {
                      a.$broadcast(
                        'LocalStorageModule.notification.error',
                  ...
                  if (
                    (null === c
                      ...
                      : e(h) && 0 !== h
                        ...
                        : 0 !== q.expiry &&
                          (l.setTime(
                            l.getTime() + 24 * q.expiry * 60 * 60 * 1e3
                          ),
                          (k = '; expires=' + l.toGMTString())),
                    b)
                  ) {
                    var n = '; path=' + q.path;
                    q.domain && (m = '; domain=' + q.domain),
                      (j.cookie =
                        t(b) + '=' + encodeURIComponent(c) + k + n + m);
                  }
                } catch (o) {
                  return (
                    a.$broadcast(
                ...
                for (
                  ...
                  if (0 === e.indexOf(t(b) + '=')) {
                    var f = decodeURIComponent(
                      e.substring(p.length + b.length + 1, e.length)
                    );
                    try {
                      return JSON.parse(f);
                    } catch (g) {
              ...
              G = function() {
                for (
                  var a = null, b = p.length, c = j.cookie.split(';'), d = 0;
                  d < c.length;
                  d++
                ) {
            ...
            w &&
              (b.addEventListener
                ? b.addEventListener('storage', m, !1)
                : b.attachEvent && b.attachEvent('onstorage', m));
            var J = function() {
